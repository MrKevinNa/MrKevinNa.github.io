...
`GET()` 방식으로 웹 데이터를 수집하려면 URL을 잘 구성해야 합니다. 이번 예제에서는 서울특별시 영등포구 여의도동으로 구역을 지정하고 아파트 매매 목록을 확인해보겠습니다. 한 화면당 30개의 매물이 화면에 출력됩니다.
...
```
    ...
    ##  $ 거래         : chr  "매매" "매매" "매매" "매매" ...
    ##  $ 종류         : chr  "주상복합" "주상복합" "주상복합" "주상복합" ...
    ##  $ 확인일자     : chr  "18.01.24." "18.01.24." "18.01.26." "18.01.26." ...
    ##  $ 현장확인 사진: chr  "여의도금호리첸시아\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기" "57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114" "롯데캐슬엠파이어\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기" "79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산" ...
    ##  $ 매물명       : chr  "여의도금호리첸시아\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기" "57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114" "롯데캐슬엠파이어\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기" "79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산" ...
    ##  $ 면적(㎡)     : chr  "188B/147\n\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t공급면적 188.43㎡\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t"| __truncated__ "57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114" "254/199\n\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t공급면적 254.43㎡\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\"| __truncated__ "79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산" ...
    ##  $ 층           : chr  "10/40" "57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114" "33/39" "79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산" ...
    ##  $ 매물가(만원) : chr  "113,000" "113,000" "150,000" "150,000" ...
    ##  $ 연락처       : chr  "명가 공인중개사사무소02-761-4848" "57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114" "롯데캐슬 공인중개사사무소02-783-1002" "79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산" ...
...
```
    ...
    ## 2                57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114
    ## 3              롯데캐슬엠파이어\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기
    ## 4  79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산
    ## 5                          목화\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기
    ## 6      15매매 특A 한강조망 세안고 초역세권\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산뱅크
    ## 7                    여의도자이\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t네이버부동산에서 보기
    ...
    ## 2                57 반듯한구조 입주협의가능\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산114
    ## 3                                                                   롯데캐슬 공인중개사사무소02-783-1002
    ## 4  79매매 전속중개 내부올수리 전세안고매매\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산
    ## 5                                                                              딸기공인중개사02-785-0043
    ## 6      15매매 특A 한강조망 세안고 초역세권\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t부동산뱅크
    ## 7                                                                                  정화부동산02-782-1800
    ## 8          자이79 입주가능 단지내정원 남향\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t한경부동산
...
```
    ...
    ##  [1] "188.43" "254.43" "58.44"  "262.7"  "209.02" "227.54" "60.96" 
    ##  [8] "58.44"  "58.44"  "209.02" "306.54" "207.4"  "185.98" "161.26"
    ## [15] "73.06"  "191.62" "60.96"  "100.19" "125.62" "161.26" "161.68"
    ## [22] "136.53" "237.92" "118.12" "153.59" "181.76" "209.02" "161.39"
    ## [29] "254.43" "99.81"
...
```
    ...
    ## 3  매매 주상복합 18.01.26.   롯데캐슬엠파이어 33/39      150,000
    ## 5  매매   아파트 18.01.26.               목화 12/12       75,000
    ## 7  매매 주상복합 18.01.26.         여의도자이  3/39      195,000
    ## 9  매매 주상복합 18.01.26.   롯데캐슬엠파이어 17/39      115,000
    ## 11 매매 주상복합 18.01.26.   대우트럼프월드II 30/34      165,000
    ##                                  연락처 공급면적 전용면적
    ## 1      명가 공인중개사사무소02-761-4848   188.43   147.71
    ## 3  롯데캐슬 공인중개사사무소02-783-1002   254.43   199.46
    ## 5             딸기공인중개사02-785-0043    58.44    51.07
    ## 7                 정화부동산02-782-1800   262.70   210.38
    ## 9  롯데캐슬 공인중개사사무소02-783-1002   209.02   163.86
    ## 11 롯데캐슬 공인중개사사무소02-783-1002   227.54   179.78
...
마지막으로 `매물가(만원)` 컬럼에서 `,`을 삭제하고 문자를 숫자 벡터로 변환하겠습니다. 아울러 컬럼명도 `호가`로 변경합니다. 동시에 `연락처`를 `부동산`으로 함께 바꾸겠습니다.
...
```
    ...
    ## 3  매매 주상복합 18.01.26.   롯데캐슬엠파이어   254.43   199.46 33/39
    ## 5  매매   아파트 18.01.26.               목화    58.44    51.07 12/12
    ## 7  매매 주상복합 18.01.26.         여의도자이   262.70   210.38  3/39
    ## 9  매매 주상복합 18.01.26.   롯데캐슬엠파이어   209.02   163.86 17/39
    ## 11 매매 주상복합 18.01.26.   대우트럼프월드II   227.54   179.78 30/34
    ## 13 매매   아파트 18.01.26.               시범    60.96    60.96 11/13
    ## 15 매매   아파트 18.01.26.               목화    58.44    51.07  7/12
    ## 17 매매   아파트 18.01.26.               목화    58.44    51.07 12/12
    ## 19 매매 주상복합 18.01.26.   롯데캐슬엠파이어   209.02   163.86 30/39
    ##      호가   부동산    전화번호
    ## 1  113000     명가 02-761-4848
    ## 3  150000 롯데캐슬 02-783-1002
    ## 5   75000     딸기 02-785-0043
    ## 7  195000     정화 02-782-1800
    ## 9  115000 롯데캐슬 02-783-1002
    ## 11 165000 롯데캐슬 02-783-1002
    ## 13  89000   베스트 02-786-8822
    ## 15  75000     정화 02-782-1800
    ## 17  75000     정화 02-782-1800
    ## 19 130000 롯데캐슬 02-783-1002
