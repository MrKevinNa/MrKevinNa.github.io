...
-   대소문자를 구분하며, 영문과 한글, 숫자를 사용할 수 있습니다.
    그러나 반드시 문자로 시작해야 합니다.
...
6.  행렬은 같은 형태의 벡터만 가집니다. (숫자형, 문자형, 복소수형, 논리형, 범주형 등)
7.  반면, 데이터프레임은 다른 형태의 벡터를 가질 수 있습니다. (단, 길이가 같아야 함)
8.  길이가 서로 다른 벡터의 경우 리스트의 형태로 저장할 수 있습니다.
9.  데이터프레임은 SAS 사용자에게 가장 익숙한 형태의 객체입니다.
...
-   logical, factor &lt; integer &lt; numeric &lt; complex &lt; character &lt; list 순
