...
이제 새로고침(F5) 합니다. 그러면 뭔가 바쁘게 움직이는 걸 볼 수 있습니다. 하단에 새로 생긴 목록에서 맨 처음 나오는 **search.asp**에 주목합니다. Method는 POST이고 Status는 200입니다. 나머지 항목들은 GET 방식으로 요청되는 것을 확인할 수 있습니다.
