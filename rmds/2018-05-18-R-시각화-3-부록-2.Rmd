...
```{r echo=FALSE}
library(htmltools)
includeHTML(path = '../images/2018-05-18-R-시각화-3-부록-2_files/leaflet1.html')
```
...
```{r echo=FALSE}
includeHTML(path = '../images/2018-05-18-R-시각화-3-부록-2_files/leaflet2.html')
```
...
```{r echo=FALSE}
includeHTML(path = '../images/2018-05-18-R-시각화-3-부록-2_files/leaflet3.html')
```
