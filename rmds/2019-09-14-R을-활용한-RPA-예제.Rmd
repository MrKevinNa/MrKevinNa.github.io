---
title: "네이버 금융 주요 시장지표 수집 및 이메일 발송"
subtitle: '주요 시장지표 수집 후 이메일 발송'
author: 'Dr.Kevin'
date: '09/14/2019'
categories: ['R']
...
네이버 금융 사이트에서 수집한 데이터를 구글쉬트 양식에 추가하려면 **googlesheets** 패키지를 사용해야 합니다. 이 패키지를 호출한 다음 인증 과정을 거쳐야 하는데요. `gs_auth()` 함수를 실행하면 간단하게 해결할 수 있습니다. 당연히 `Google ID`가 있어야 합니다. 그래야 구글드라이브를 연결할 수 있으니까요. 
